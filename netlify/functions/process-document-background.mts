...
export default async (request: Request, context: Context) => {
  ...
  try {
    ...
    await drafts.set(`${documentId}-status`, JSON.stringify({
      status: 'processing',
      step: 'initializing',
      progress: 10,
...
- Modify the metadata fields to match your frontmatter structure
- Add any additional fields you need (tags, categories, etc.)
- Customize the content style for your audience
...
function processMarkdownImages(markdown: string, imageMapping: Record<string, string>) {
